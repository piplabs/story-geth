...
func SetEthConfig(ctx *cli.Context, stack *node.Node, cfg *ethconfig.Config) {
	...
	flags.CheckExclusive(ctx, MainnetFlag, DeveloperFlag, SepoliaFlag, HoleskyFlag, IliadFlag, OdysseyFlag, AeneidFlag, StoryFlag, LocalFlag, HoodiFlag, NetworkIdFlag)
