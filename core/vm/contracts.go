...
func RunPrecompiledContract(evm *EVM, caller common.Address, p PrecompiledContract, input []byte, suppliedGas uint64, logger *tracing.Hooks) (ret []byte, remainingGas uint64, err error) {
...
func (c *ecrecover) Run(evm *EVM, caller common.Address, input []byte) ([]byte, error) {
...
func (c *sha256hash) Run(evm *EVM, caller common.Address, input []byte) ([]byte, error) {
...
func (c *ripemd160hash) Run(evm *EVM, caller common.Address, input []byte) ([]byte, error) {
...
func (c *dataCopy) Run(evm *EVM, caller common.Address, in []byte) ([]byte, error) {
...
func (c *bigModExp) Run(evm *EVM, caller common.Address, input []byte) ([]byte, error) {
	var (
...
func (c *bn256AddIstanbul) Run(evm *EVM, caller common.Address, input []byte) ([]byte, error) {
...
func (c *bn256AddByzantium) Run(evm *EVM, caller common.Address, input []byte) ([]byte, error) {
	return runBn256Add(input)
}
...
func (c *bn256ScalarMulIstanbul) Run(evm *EVM, caller common.Address, input []byte) ([]byte, error) {
...
func (c *bn256ScalarMulByzantium) Run(evm *EVM, caller common.Address, input []byte) ([]byte, error) {
	return runBn256ScalarMul(input)
}
...
func (c *bn256PairingIstanbul) Run(evm *EVM, caller common.Address, input []byte) ([]byte, error) {
...
func (c *bn256PairingByzantium) Run(evm *EVM, caller common.Address, input []byte) ([]byte, error) {
	return runBn256Pairing(input)
}
...
func (c *blake2F) Run(evm *EVM, caller common.Address, input []byte) ([]byte, error) {
...
func (c *bls12381G1Add) Run(evm *EVM, caller common.Address, input []byte) ([]byte, error) {
...
func (c *bls12381G1Mul) Run(evm *EVM, caller common.Address, input []byte) ([]byte, error) {
...
func (c *bls12381G1MultiExp) Run(evm *EVM, caller common.Address, input []byte) ([]byte, error) {
...
func (c *bls12381G2Add) Run(evm *EVM, caller common.Address, input []byte) ([]byte, error) {
...
func (c *bls12381G2Mul) Run(evm *EVM, caller common.Address, input []byte) ([]byte, error) {
...
func (c *bls12381G2MultiExp) Run(evm *EVM, caller common.Address, input []byte) ([]byte, error) {
...
func (c *bls12381Pairing) Run(evm *EVM, caller common.Address, input []byte) ([]byte, error) {
...
func (c *bls12381MapG1) Run(evm *EVM, caller common.Address, input []byte) ([]byte, error) {
...
func (c *bls12381MapG2) Run(evm *EVM, caller common.Address, input []byte) ([]byte, error) {
...
func (b *kzgPointEvaluation) Run(evm *EVM, caller common.Address, input []byte) ([]byte, error) {
